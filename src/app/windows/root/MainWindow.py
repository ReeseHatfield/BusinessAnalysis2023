...
from src.app.windows.tender.TenderFrame import TenderFrame
...
class MainWindow:
    ...
    def create_tab(self, tab_name):
        ...
        elif tab_name == "Tender":
            tender_frame = TenderFrame(frame)
            tender_frame.grid(row=1, column=0, sticky='nesw', padx=16, pady=16)
